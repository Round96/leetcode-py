...
# Runtime: 36 ms, faster than 77.17% of Python3 online submissions for Kids With the Greatest Number of Candies.
# Memory Usage: 13.8 MB, less than 78.26% of Python3 online submissions
...
class Solution:
    def kidsWithCandies(
        ...
        i = 0
        while i < len(candies):
            result.append(candies[i] + extraCandies >= largest)
            i = i + 1
