...
#
#
#  Updates all values with newValue in the subrectangle whose upper left coordin
# ate is (row1,col1) and bottom right coordinate is (row2,col2).
#
#
...
#
#
#  There will be at most 500 operations considering both methods: updateSubrecta
# ngle and getValue.
#  1 <= rows, cols <= 100
...
# Runtime: 212 ms, faster than 82.74% of Python3 online submissions for Subrectangle Queries.
# Memory Usage: 15.6 MB, less than 60.00% of Python3 online submissions
# for Subrectangle Queries.
...
class SubrectangleQueries:
    ...
    def updateSubrectangle(self, row1: int, col1: int,
                           row2: int, col2: int, newValue: int) -> None:
